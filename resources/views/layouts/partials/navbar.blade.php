    ...
    <div class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center me-5">
            ...
            <div class="ms-5 ms-md-10">
                <!--begin::Toggle-->
                <button type="button"
                    class="btn btn-flex btn-active-color-white align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-white bg-opacity-10 btn-color-gray-600 px-0 ps-md-6 pe-md-5 h-30px w-30px h-md-35px w-md-200px"
                ...
                <!--end::Toggle-->
                <!--begin::Menu-->
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg fw-semibold w-200px pb-3"
                    data-kt-menu="true">
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <div class="menu-content fs-7 text-dark fw-bold px-3 py-4">Select
                            department:</div>
                    </div>
                    <!--end::Menu item-->
        ...
        <div class="d-flex align-items-center flex-shrink-0">
            ...
            <!--end::Theme mode-->
            @php($user = \App\CPU\Helpers::getAuth(session()->get('user_id')))
            <!--begin::User-->
            <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                ...
                <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3"
                    ...
                    <div
                        ...
                        <span class="text-muted fs-8 fw-semibold lh-1 mb-1">{{ $user['name'] }}</span>
                        <span class="text-white fs-8 fw-bold lh-1">{{ \App\CPU\Helpers::getOutlet($user['outlet_id'])["nama_outlet"] ?? 'Invalid Outlet'}}</span>
                    </div>
                    <!--end::Name-->
                    <!--begin::Symbol-->
                    <div class="symbol symbol-30px symbol-md-40px">
                        <img src="{{ $user['detail']['img'] ?? '' }}" onerror="this.src='{{ asset('assets/img/user.png') }}'"  alt="image" />
                    </div>
                    <!--end::Symbol-->
                </div>
                <!--end::User info-->
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="{{ $user['detail']['img'] ?? '' }}" onerror="this.src='{{ asset('assets/img/user.png') }}'" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">{{ $user['name'] }}
                                    <span
                                        class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ $user['role']['role'] ?? 'Invalid Role' }}</span>
                                </div>
                                <a href="#"
