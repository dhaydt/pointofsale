    ...
    <div class="aside-menu flex-column-fluid px-4">
        <div class="hover-scroll-overlay-y my-5 pe-4 me-n4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_aside_menu"
                ...
                <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Absen</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'absen' ? 'active' : '' }}" href="{{ route('absen') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'payroll' ? 'active' : '' }}" href="{{ route('payroll') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-list-columns-reverse" viewBox="0 0 16 16">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'cabang' ? 'active' : '' }}" href="{{ route('cabang') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'outlet' ? 'active' : '' }}" href="{{ route('outlet') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'kategori' ? 'active' : '' }}" href="{{ route('kategori') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'produk' ? 'active' : '' }}" href="{{ route('produk') }}">
                        <span class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'jasa' ? 'active' : '' }}" href="{{ route('jasa') }}">
                        <span class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'admin' ? 'active' : '' }}" href="{{ route('admin') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'roles' ? 'active' : '' }}" href="{{ route('roles') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <span class="menu-title">Hak Akses (Roles)</span>
                    </a>
                </div>
                <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Berita</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ $active == 'news' ? 'active' : '' }}" href="{{ route('news') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
