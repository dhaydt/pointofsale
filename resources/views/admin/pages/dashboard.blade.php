                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            ...
                                            data-dropdown-parent="#kt_menu_6388b19d934fc" data-allow-clear="true">
                                            <option></option>
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold">New
                                        Users</a>
                                    <span class="text-muted fw-semibold d-block fs-7">John,
                                        Pat, Jimmy</span>
                                </div>
                    ...
                    <div class="card h-100 bgi-no-repeat bgi-size-cover h-lg-100"
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="text-white fw-bold fs-2">
                                <h2 class="fw-bold text-white mb-2">Create Reports</h2>With
                                App
                            </div>
                            <!--end::Title-->
                            <!--begin::Link-->
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            data-placeholder="Select option"
                                            data-dropdown-parent="#kt_menu_6388b19d937f1" data-allow-clear="true">
                                            <option></option>
                                            <option value="1">Approved</option>
                                            <option value="2">Pending</option>
                                            <option value="2">In Process</option>
                        ...
                        <table class="table align-middle gs-0 gy-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end text-dark fw-bold fs-6 pe-0">5.4MB
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Popular
                                            Authors</a>
                                    </td>
                                    <td class="text-end text-muted fw-bold">Python, MySQL
                                    </td>
                                    <td class="text-end text-muted fw-bold">7200 Users</td>
                                    <td class="text-end text-dark fw-bold fs-6 pe-0">2.8MB
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-end text-dark fw-bold fs-6 pe-0">1.5MB
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Active
                                            Customers</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-dark fw-bold fs-6 pe-0">500KB
                                    </td>
                                </tr>
                            </tbody>
                            <!--end::Table body-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    ...
                                                    Clarcson</a>
                                                <span class="text-muted fw-semibold d-block">HTML,
                                                    CSS Coding</span>
                                            </td>
                                            <td>
                                                <span class="text-muted fw-semibold d-block fs-7">Paid</span>
