                ...
                <div class="card-body pt-9 pb-0">
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $name
                                            }}</a>
                                        <a href="#">
                                        ...
                                        <a href="javascript:"
                                            class="btn text-capitalize btn-sm btn-light-success fw-bold ms-2 fs-8 py-1 px-3"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">{{
                                            \App\CPU\Helpers::getRole($role_id)['role'] ?? 'Invalid Role' }}</a>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                        <a href="javascript:"
                                            ...
                                            data-bs-toggle="tooltip" title="Outlet">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com006.svg-->
                                            <span class="svg-icon svg-icon-4 me-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    fill="grey" class="bi bi-shop-window" viewBox="0 0 24 24">
                                                    <path
                                            ...
                                            {{ $user->outlet->nama_outlet ?? 'Invalid Outlet' }}
                                        </a>
                                        <a href="javascript:"
                        ...
                        <div class="ms-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative"
                                style="width: 200px">
                                <img class="w-100" src="{{ asset($photo_ktp) }}"
                                    onerror="this.src='{{ asset('assets/img/ktp-logo.png') }}'" alt="ktp">
                                {{-- <div
                                    class="position-absolute translate-middle bottom-0 start-100 mb-6 bg-success rounded-circle border border-4 border-body h-20px w-20px">
                                </div> --}}
                            </div>
                    ...
                    {{-- <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                href="statements.html">Statements</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-bold fs-6 text-gray-800">{{ $nik ?? 'Belum ada data' }}
                                @if($nik == '')
                                Belum ada data
                                @endif
                            </span>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-bold fs-6 text-gray-800">{{ $no_kk ?? 'Belum ada data' }}
                                @if($no_kk== '')
                                Belum ada data
                                @endif
                            </span>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            <span class="fw-semibold text-gray-800 fs-6">{{
                                \App\CPU\Helpers::getOffice($cabang_id)['nama_office'] ?? 'Invalid Cabang' }}</span>
                        </div>
                    </div>
                    <div class="row mb-7">
                        <label class="col-lg-4 fw-semibold text-muted">Outlet</label>
                        <div class="col-lg-8 fv-row">
                            <span class="fw-semibold text-gray-800 fs-6">{{ $user['outlet']['nama_outlet'] ?? 'Invalid
                                Outlet' }}</span>
                        </div>
                    </div>
                    <div class="row mb-7">
                        <label class="col-lg-4 fw-semibold text-muted">Handphone
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                aria-label="Phone number must be active" data-bs-original-title="Nomor Handphone"
                                data-kt-initialized="1"></i></label>
                        <div class="col-lg-8 d-flex align-items-center">
                            <span class="fw-bold fs-6 text-gray-800 me-2">{{ $phone ?? 'Belum ada data' }}
                                @if($phone == '')
                                Belum ada data
                                @endif
                            </span>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <a href="javascript:" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $kelamin
                                ?? 'Belum ada data' }}
                                @if($kelamin == '')
                                Belum ada data
                                @endif
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <a href="javascript:" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $agama
                                }}
                                @if($agama == '')
                                Belum ada data
                                @endif
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <a href="javascript:" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{
                                $alamat_ktp ?? 'Belum ada data' }}
                                @if($alamat_ktp == '')
                                Belum ada data
                                @endif
                            </a>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <a href="javascript:" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $domisili
                                ?? 'Belum ada data' }}
                                @if($domisili == '')
                                Belum ada data
                                @endif
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-bold fs-6 text-gray-800">{{ $tempat_lahir ?? 'Belum ada data' }}
                                @if($tempat_lahir == '')
                                Belum ada data
                                @endif
                            </span>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-semibold fs-6 text-gray-800">{{ $tanggal_lahir ?? 'Belum ada data' }}
                                @if($tanggal_lahir == '')
                                Belum ada data
                                @endif
                            </span>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-semibold fs-6 text-gray-800">{{ $kewarganegaraan ?? 'Belum ada
                                data'}}
                                @if($kewarganegaraan == '')
                                Belum ada data
                                @endif
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-semibold fs-6 text-gray-800">{{ $nama_ibu ?? 'Belum ada data' }}
                                @if($nama_ibu == '')
                                Belum ada data
                                @endif
                            </span>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-semibold fs-6 text-gray-800">{{ $jabatan ?? 'Belum ada data' }}
                                @if($jabatan == '')
                                Belum ada data
                                @endif
                            </span>
